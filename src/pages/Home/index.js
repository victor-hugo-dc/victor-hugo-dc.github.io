            ...
            <div className="flex flex-col justify-center items-start max-w-2xl mx-auto">
                ...
                <div className="mb-8 prose leading-6 text-justify text-gray-600 dark:text-gray-400">
                    <p>
                        ...
                        <br /><br />
                        AFK, I enjoy the outdoors: camping, hiking, fishing. I&apos;ve recently picked up tennis and have previously trained Muay Thai. Creatively, I like to express myself with cameras and charcoal. I recently fixed up my dad&apos;s retro Palmcorder and have been collecting memories on cassette tapes. Check out my résumé.
                        <br /><br />
